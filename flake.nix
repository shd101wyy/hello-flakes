{
  ...
  inputs = {
    nixpkgs = {
      ...
      url = "github:NixOS/nixpkgs?rev=809cca784b9f72a5ad4b991e0e7bcf8890f9c3a6";
    };
    nixpkgs-unstable = {
    ...
    home-manager = {
      url = "github:nix-community/home-manager?ref=release-23.11"; # The version here should match `nixpkgs`
